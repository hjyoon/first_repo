...
2. 어떤 X가 KOI 유전자라면, aXt와 gXc도 KOI 유전자이다. 예를 들어, agct 와 gaattc는 KOI유전자이나, tgca 와 cgattc 는 KOI유전자가 아니다. 
3. 어떤 X와 Y가 KOI 유전자라면 이 둘을 연결한 XY 도 KOI 유전자이다. 예를 들면 aattgc 또는 atat 는 KOI 유전자이지만 atcg 또는 tata 는 KOI 유전자가 아니다. 
